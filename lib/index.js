...
module.exports = {
  ...
  ...require('./wallet-watch'),// watchWallet, judgeCounterparty
  ...require('./agent-vet'),   // vetAgent, introspectHttp, auditTools
  ...require('./seedscan'),    // scanPaths, scanText, checksumValid, loadWordlist
  ...require('./keyscan'),     // scanKeyPaths, scanKeyText, readKeystore, findVaults    // scanPaths, scanText, checksumValid, loadWordlist   // vetAgent, introspectHttp, auditTools
};
