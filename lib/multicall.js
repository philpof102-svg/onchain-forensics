...
async function allowancesBatch(chain, owner, pairs) {
  ...
  return res.map((r) => {
     ...
     * son retour est illisible — c'est un NON-LU, pas un revert. Le classer en `false` (« repondu
     * definitivement: aucune allocation ») laissait approvals.js declarer le balayage `complete`, ce qui
     * autorisait wallet-watch a remplacer sa reference et a rapporter ensuite une allocation jamais lue
     * comme « nouvellement accordee ». Corrige dans biii le 2026-07-27; porte ici le meme jour. */
